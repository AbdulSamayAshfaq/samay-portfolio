        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Abdul Samay and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Gaming, Football and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> samayali692@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        ...
                        <div>
                        <img alt="express" className="icons-skils" src="https://s3.dualstack.us-east-2.amazonaws.com/pythondotorg-assets/media/files/python-logo-only.svg" />
                        <h5>Python</h5>
                    </div>
                    <div>
